...
def initialize(context):
    ...
    context.stock_pairs = [(symbol('BABA'), symbol('JD'))    
                           (symbol('AMD'), symbol('NVDA')),
                           (symbol('ADBE'),   symbol('CRM')),
                           (symbol('AAPL'), symbol('MSFT')),
                           (symbol('FB'),   symbol('SNAP')),
                           (symbol('TWTR'), symbol('SOHU'))]
    context.stocks = [symbol('BABA'), symbol('JD')
    , symbol('AMD'), symbol('NVDA'),\
                      symbol('ADBE'), symbol('CRM'), symbol('AAPL'), symbol('MSFT'), symbol('FB'),\                     symbol('SNAP'),symbol('TWTR'),symbol('SOHU')]
    context.num_pairs = len(context.stock_pairs)
    # strategy specific variables
    context.lookback = 30 # used for regression
